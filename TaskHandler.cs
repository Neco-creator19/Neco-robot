...
public class TaskHandler
{
    ...
    public static void ProcessCommand(string command, ref int batteryLevel)
    {
        ...
        {
            case "master":
                ListTasks(myTasks,"Master's Tasks List");break;
            
            case "neco":
                ListTasks(necoTasks,"Neco's Tasks List");break;
            ...
            Console.WriteLine("Available command: 'master', 'neco', 'battery', 'exit'");break;
        }
    }
    public static void
